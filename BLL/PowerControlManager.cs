...
namespace BLL
{
    ...
    { //报警器
        ...
        private static readonly string PowerCOM = ConfigurationManager.ConnectionStrings["PowerCOM"].ConnectionString; //Com口配置
